...
主要是这个函数 `zend_hash_compare()`
**key 0 and the key 4294967296 and many other keys are considered identical**
### EXP
```
user[4294967296]=5;user[1]=hund;
```
第五个的md5(06e2b745f3124f7d670f78eabaa94809)原来的值是`hund`，所以我们要把前面那个lead掉
